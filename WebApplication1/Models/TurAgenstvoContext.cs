...
public partial class TurAgenstvoContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Server= 44-1\\SQLEXPRESS;Database=TurAgenstvoо;TrustServerCertificate=True;Trusted_Connection=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Reservation>(entity =>
        {
            ...
            entity.HasOne(d => d.IdClientNavigation).WithMany(p => p.Reservations)
                ...
                .HasConstraintName("FK_Reservation_Client").OnDelete(DeleteBehavior.ClientSetNull);
        ...
        {
            entity.HasKey(e => e.IdTourSchedule);

            entity.ToTable("Tour_Schedule");

            entity.Property(e => e.IdTourSchedule).HasColumnName("id_tour_schedule");
            ...
            entity.HasOne(d => d.Tour).WithMany(p => p.TourSchedules)
                ...
                .HasConstraintName("FK_Tour_Schedule_Tour");
        });
